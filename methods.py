...
def estimate_transform_from_correspondences(moving, static, n_iter, centroids, intervals, assignments_fn,
                                            progress_bar=None):
...
estimate_transform_from_binary_correspondences = partial(estimate_transform_from_correspondences,
                                                         assignments_fn=get_binary_assignments_from_centroids)
estimate_transform_from_soft_correspondences = partial(estimate_transform_from_correspondences,
